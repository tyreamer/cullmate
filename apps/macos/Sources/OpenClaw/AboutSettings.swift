...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/tyreamer/cullmate") {
            ...
            VStack(spacing: 3) {
                ...
                Text("Your Studio Manager — handles everything around the edit.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/tyreamer/cullmate")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://baxbot.ai")
            }
            ...
            Text("© 2026 Ty Reamer. Based on OpenClaw (MIT License).")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "BaxBotBuildTimestamp") as? String) ??
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "BaxBotGitCommit") as? String) ??
