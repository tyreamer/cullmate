...
function buildDocsSection(params: { docsPath?: string; isMinimal: boolean; readToolName: string }) {
  ...
  return [
    ...
    "When diagnosing issues, run `baxbot status` yourself when possible; only ask the user if you lack access (e.g., sandboxed).",
    "",
  ];
}
...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "- baxbot gateway status",
    "- baxbot gateway start",
    "- baxbot gateway stop",
    "- baxbot gateway restart",
    "If unsure, ask the user to run `baxbot help` (or `baxbot gateway --help`) and paste the output.",
    "",
    ...skillsSection,
    ...memorySection,
