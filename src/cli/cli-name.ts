...
export const DEFAULT_CLI_NAME = "baxbot";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "cullmate", "openclaw"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(baxbot|cullmate|openclaw)\b/;
