...
APP_BUNDLE="${1:-dist/macos/BaxBot.app}"
...
# Sign main binary
if [ -f "$APP_BUNDLE/Contents/MacOS/BaxBot" ]; then
  echo "Signing main binary"; sign_item "$APP_BUNDLE/Contents/MacOS/BaxBot" "$APP_ENTITLEMENTS"
fi
